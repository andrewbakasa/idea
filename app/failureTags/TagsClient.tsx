...
import { SafeFailureTag,  SafeUser } from "../types";
...
import { FailureTagFormPopover } from "../components/form/failure-tag-form-popover";
...
const TagsClient: React.FC<UsersClientProps> = ({
  ...
  const columnHelper = createColumnHelper<SafeFailureTag>()
...
const handlePageSizeChange = (newPageSize: PageSizeOption) => {
 ...
 const calculatePageSlice = (fList?: SafeFailureTag[], itemOffset?: number, pageSize?: number): SafeFailureTag[] | undefined => {
   if (!fList|| !pageSize) {
     return undefined;
   }
        ...
        <div>
          {
            ...
            ( 
              <div 
                ...
                >
                  ...
                  <FailureTagFormPopover sideOffset={isMobile?-125:10} side={popover_content_pos }>
                    <div
                      role="button"
            ...
            (
              <>
                ...
                /> 
                <FailureTagFormPopover sideOffset={10} side={popover_content_pos }>
                    <div
                      role="button"
                      className="aspect-video relative h-[75px] w-[200px] bg-muted rounded-sm flex flex-col gap-y-1 items-center justify-center hover:opacity-75 transition"
                    >
