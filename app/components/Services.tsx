          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                We specialize in creating and optimizing high-quality, custom CAD models and simulations for businesses and organizations of all sizes. Our expertise enhances design accuracy, streamlines manufacturing and fabrication processes, and improves maintenance planning and execution.  </p>
              </div>
            </div>
            ...
            <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                We provide high-quality, custom data analytics solutions that transform raw information into actionable insights. Empowering business with robust, scalable, and accessible analytics to drive better decisions and optimize performance.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                <Image
                  ...
                  src={img3}
                />
                <h2 className="font-semibold my-4 text-2xl text-center ">Engineering Maintenance and Operations</h2>
                <p className="text-md font-medium">
                We provide comprehensive engineering maintenance and operational support to businesses, ensuring the reliability, efficiency, and longevity of their critical assets and systems.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                We offer expert consultation and development services in General Artificial Intelligence and Machine Learning, empowering businesses and individuals to leverage these cutting-edge technologies for innovation, automation, and enhanced decision-making.
                </p>
              </div>
            </div>
          </div>
