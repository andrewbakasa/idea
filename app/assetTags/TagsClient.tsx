...
import { SafeAssetCategory, SafeUser } from "../types";
...
import { AssetTagFormPopover } from "../components/form/asset-tag-form-popover";

interface UsersClientProps {
  tags: SafeAssetCategory[],
...
const TagsClient: React.FC<UsersClientProps> = ({
  ...
  const columnHelper = createColumnHelper<SafeAssetCategory>()
...
const handlePageSizeChange = (newPageSize: PageSizeOption) => {
 ...
 const calculatePageSlice = (fList?: SafeAssetCategory[], itemOffset?: number, pageSize?: number): SafeAssetCategory[] | undefined => {
   if (!fList|| !pageSize) {
     return undefined;
   }
        ...
        <div>
          {
            ...
            ( 
              <div 
                ...
                >
                  ...
                  <AssetTagFormPopover sideOffset={isMobile?-125:10} side={popover_content_pos }>
                    <div
                      role="button"
            ...
            (
              <>
                ...
                /> 
                <AssetTagFormPopover sideOffset={10} side={popover_content_pos }>
                    <div
                      role="button"
                      className="aspect-video relative h-[75px] w-[200px] bg-muted rounded-sm flex flex-col gap-y-1 items-center justify-center hover:opacity-75 transition"
                    >
