...
import { SafeFailureTag, SafeTag, SafeUser } from "@/app/types"; 
import { Separator } from "@/components/ui/separator";
import { cn } from "@/lib/utils";
import { updateFailureTag } from "@/actions/update-failure-tag";
...
export const TagData = ({
  ...
  const { execute, fieldErrors } = useAction(updateFailureTag, {
    onSuccess: (data) => {
