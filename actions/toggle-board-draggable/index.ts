    ...
    if (child && 
     ...
     //toggle
      board=  await prisma.board.update({
          where: { id: child.id },
          data: {  dragMode:child?.dragMode?!child.dragMode:true },// if not there create one
      });
...
export const toggleBoardDraggable = createSafeAction(ToggleBoardDraggable, handler);
